  ...
  while (($.copy(i)).lt($.copy(WORDS))) {
    {
      a1 = get_(a, $.copy(i), $c);
      b1 = get_(b, $.copy(i), $c);
      put_(ret, $.copy(i), ($.copy(a1)).and($.copy(b1)), $c);
      i = ($.copy(i)).add(u64("1"));
    }
  ...
  while (($.copy(i)).lt($.copy(WORDS))) {
    {
      a1 = get_(a, $.copy(i), $c);
      b1 = get_(b, $.copy(i), $c);
      put_(ret, $.copy(i), ($.copy(a1)).or($.copy(b1)), $c);
      i = ($.copy(i)).add(u64("1"));
    }
  ...
  while (($.copy(i)).lt($.copy(WORDS))) {
    {
      a1 = get_(a, $.copy(i), $c);
      b1 = get_(b, $.copy(i), $c);
      put_(ret, $.copy(i), ($.copy(a1)).xor($.copy(b1)), $c);
      i = ($.copy(i)).add(u64("1"));
    }
...
export function loadParsers(repo: AptosParserRepo) {
  repo.addParser("0x4e9fce03284c0ce0b86c88dd5a46f050cad2f4f33c4cdd29d98f501868558c81::u256::DU256", DU256.DU256Parser);
  repo.addParser("0x4e9fce03284c0ce0b86c88dd5a46f050cad2f4f33c4cdd29d98f501868558c81::u256::U256", U256.U256Parser);
}
export class App {
  constructor(
