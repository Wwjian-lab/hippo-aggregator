...
export function mock_deploy_aux_ (
  admin: HexString,
  $c: AptosDataCache,
): void {
  deploy_aux_(admin, $.copy(BTC_AMOUNT), $.copy(STABLE_COIN_AMOUNT), $c, [new StructTag(new HexString("0x498d8926f16eb9ca90cab1b3a26aa6f97a080b3fcbe6e83ae150b7243a00fb68"), "devnet_coins", "DevnetBTC", []), new StructTag(new HexString("0x498d8926f16eb9ca90cab1b3a26aa6f97a080b3fcbe6e83ae150b7243a00fb68"), "devnet_coins", "DevnetUSDC", [])]);
  deploy_aux_(admin, $.copy(BTC_AMOUNT), $.copy(STABLE_COIN_AMOUNT), $c, [new StructTag(new HexString("0x498d8926f16eb9ca90cab1b3a26aa6f97a080b3fcbe6e83ae150b7243a00fb68"), "devnet_coins", "DevnetBTC", []), new StructTag(new HexString("0x498d8926f16eb9ca90cab1b3a26aa6f97a080b3fcbe6e83ae150b7243a00fb68"), "devnet_coins", "DevnetUSDT", [])]);
  deploy_aux_(admin, $.copy(STABLE_COIN_AMOUNT), $.copy(STABLE_COIN_AMOUNT), $c, [new StructTag(new HexString("0x498d8926f16eb9ca90cab1b3a26aa6f97a080b3fcbe6e83ae150b7243a00fb68"), "devnet_coins", "DevnetUSDC", []), new StructTag(new HexString("0x498d8926f16eb9ca90cab1b3a26aa6f97a080b3fcbe6e83ae150b7243a00fb68"), "devnet_coins", "DevnetUSDT", [])]);
...
export function mock_deploy_pontem_ (
  ...
  deploy_pontem_(admin, $.copy(STABLE_COIN_AMOUNT), $.copy(STABLE_COIN_AMOUNT), $c, [new StructTag(new HexString("0x498d8926f16eb9ca90cab1b3a26aa6f97a080b3fcbe6e83ae150b7243a00fb68"), "devnet_coins", "DevnetUSDC", []), new StructTag(new HexString("0x498d8926f16eb9ca90cab1b3a26aa6f97a080b3fcbe6e83ae150b7243a00fb68"), "devnet_coins", "DevnetUSDT", []), new StructTag(new HexString("0x190d44266241744264b964a37b8f09863167a12d3e70cda39376cfb4e3561e12"), "curves", "Stable", [])]);
  deploy_pontem_(admin, $.copy(STABLE_COIN_AMOUNT), $.copy(STABLE_COIN_AMOUNT), $c, [new StructTag(new HexString("0x498d8926f16eb9ca90cab1b3a26aa6f97a080b3fcbe6e83ae150b7243a00fb68"), "devnet_coins", "DevnetDAI", []), new StructTag(new HexString("0x498d8926f16eb9ca90cab1b3a26aa6f97a080b3fcbe6e83ae150b7243a00fb68"), "devnet_coins", "DevnetUSDC", []), new StructTag(new HexString("0x190d44266241744264b964a37b8f09863167a12d3e70cda39376cfb4e3561e12"), "curves", "Stable", [])]);
  return;
}
